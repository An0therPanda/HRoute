        ...
        <script>
          $(document).ready(function() {
            $("#login").validate({
              ...
              messages: {
                usuario: {
                  required: "Porfavor ingrese un"
                },
                passwd: {
                  required: "Porfavor ingrese una"
                }
              }
            });
          });
                  ...
                  <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">          
                      <div class="mb-md-5 mt-md-4 pb-5">          
                        ...
                        <input class="btn btn-outline-light btn-lg px-5" id="btnLogin" name="login" type="submit" value="Ingresar">    
                        <br>
                        <span>
                          <?php
